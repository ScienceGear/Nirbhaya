...
export default function LoginPage() {
  ...
  return (
    <div className="bg-gradient-hero min-h-screen flex items-center justify-center px-4 py-6">
      <motion.div
      ...
      >
        <div className="bg-card border border-border rounded-3xl shadow-elevated p-5 sm:p-7">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            {isSignup
              ? signupStep === 1 ? "Set up your Nirbhaya profile" : "Help us keep you safe"
          ...
          {!isSignup && (
            <div className="mt-5">
              <Button type="button" variant="outline" className="h-10 w-full rounded-full" onClick={handleDemoLogin} disabled={submitting}>
